...
from fivetran_mcp_server.src.main import (
...
class TestValidateConfig:
    ...
    @patch("fivetran_mcp_server.src.main.validate_config_func")
    @patch("fivetran_mcp_server.src.main.logger")
...
class TestHandleStartupError:
    ...
    @patch("fivetran_mcp_server.src.main.logger")
    @patch("fivetran_mcp_server.src.main.sys")
...
class TestMain:
    ...
    @patch("fivetran_mcp_server.src.main.validate_config")
    @patch("fivetran_mcp_server.src.main.logger")
    @patch("fivetran_mcp_server.src.main.uvicorn")
    def test_main_success(self, mock_uvicorn, mock_logger, mock_validate):
        ...
        with patch("fivetran_mcp_server.src.main.settings", mock_settings):
            # Act
            main()
    ...
    @patch("fivetran_mcp_server.src.main.run")
    @patch("fivetran_mcp_server.src.main.logger")
    @patch("fivetran_mcp_server.src.main.sys")
    ...
    @patch("fivetran_mcp_server.src.main.validate_config")
    @patch("fivetran_mcp_server.src.main.handle_startup_error")
...
class TestRun:
    ...
    @patch("fivetran_mcp_server.src.main.main")
    @patch("fivetran_mcp_server.src.main.logger")
    @patch("fivetran_mcp_server.src.main.sys")

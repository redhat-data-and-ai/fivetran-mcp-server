"""Basic tests for the Fivetran MCP Server."""
...
import fivetran_mcp_server.src.settings as settings_mod
...
class TestSettings:
    ...
    def test_default_settings(self):
        ...
        # Arrange
        with patch("fivetran_mcp_server.src.settings.Settings") as mock_settings_class:
            mock_settings = Mock()
...
class TestServer:
    ...
    def patch_snowflake_account(self, monkeypatch):
        ...
        import fivetran_mcp_server.src.mcp as server_mod

        importlib.reload(server_mod)
        self.FivetranMCPServer = server_mod.FivetranMCPServer
    ...
    def test_health_endpoint(self):
        ...
        # Arrange
        with patch("fivetran_mcp_server.src.api.app") as mock_app:
...
class TestMain:
    ...
    def test_main_module_import(self):
        ...
        import fivetran_mcp_server.src.main as main
...
class TestIntegration:
    ...
    def test_module_imports(self):
        ...
        modules_to_test = [
            "fivetran_mcp_server.src.mcp",
            "fivetran_mcp_server.src.settings",
            "fivetran_mcp_server.src.main",
            "fivetran_mcp_server.utils.pylogger",
        ]
    ...
    def test_package_structure(self):
        ...
        import fivetran_mcp_server

        assert fivetran_mcp_server is not None

        # Test that src package exists
        import fivetran_mcp_server.src

        assert fivetran_mcp_server.src is not None

        # Test that utils package exists
        import fivetran_mcp_server.utils

        assert fivetran_mcp_server.utils is not None

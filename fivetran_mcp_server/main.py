"""Main entry point for the Fivetran MCP Server."""
...
def main() -> None:
    ...
    Initializes logging, loads configuration, and starts the Fivetran MCP server.
    ...
    try:
        ...
        logger.info("Fivetran MCP server shutting down")

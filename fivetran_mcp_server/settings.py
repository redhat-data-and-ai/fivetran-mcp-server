"""Settings for the Fivetran MCP Server."""
...
class Settings(BaseSettings):
    """Configuration settings for the Fivetran MCP Server.
    ...
    FIVETRAN_API_KEY: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "env": "FIVETRAN_API_KEY",
            "description": "Fivetran API key for authentication",
            "sensitive": True,
        },
    )
    FIVETRAN_API_SECRET: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "env": "FIVETRAN_API_SECRET",
            "description": "Fivetran API secret for authentication",
            "sensitive": True,
        },
    )
    FIVETRAN_BASE_URL: str = Field(
        ...
        json_schema_extra={
            "env": "FIVETRAN_BASE_URL",
            "description": "Fivetran API base URL",
            "example": "https://api.fivetran.com/v1",
        },
    )
